...
function Project() {
  return (
    <section id='project' className='text-gray-400 bg-gray-900'>
        <div className="container text-center px-5 py-10  md:pl-28">
                ...
                {projects.map(project =>(
                    ...
                    className='sm:w-1/2 w-100 p-4'>
                        <div className='flex relative '>
                            ...
                            <div className='px-8 py-10 relative w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100 h-96 sm:min-w-fit'>
